...
class AttachmentTest < Test::Unit::TestCase
  ...
  context "when configured to not use a temp file" do
    should "not make a temp file" do
      rebuild_model :styles => { :something => "100x100#" }, :use_temp_file => false
      @file = StringIO.new(".")
      @file.stubs(:original_filename).returns("5k.png\n\n")
      @file.stubs(:content_type).returns("image/png\n\n")

      @file.expects(:to_tempfile).never
